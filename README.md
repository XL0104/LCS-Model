...
```
python seal_link_pred.py --dataset Custom --m 3 --M 20 --use_feature --profile --seed 1
```

```
python seal_link_pred.py --dataset MiRNA --m 3 --M 20 --use_feature --profile --seed 1
```

```
python seal_link_pred.py --dataset KIBA --m 3 --M 20 --use_feature --profile --seed 1
```

```
python seal_link_pred.py --dataset Microbe --m 3 --M 20 --use_feature --profile --seed 1
```

```
python seal_link_pred.py --dataset PPI --m 3 --M 20 --use_feature --profile --seed 1
```
